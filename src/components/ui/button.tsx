...
const buttonVariants = cva(
	"not-disabled:cursor-pointer select-none inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
	{
		variants: {
			variant: {
				default:
				...
				nothing: "",
				"7sref": "inline-grid min-w-60 min-h-11 bg-gradient-to-b from-[#F9FAFE] to-[#D5E5FC] font-bold text-base text-[#446EBA] rounded-3xl inset-shadow-[0_-2px_2px_#7893C8] active:scale-[0.975]",
			},
			size: {
